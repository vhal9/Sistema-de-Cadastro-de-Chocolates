...
public class Menu {
    ...
    public void ListarTodos(){
        ArrayList<Object> chocolates = arq.retornaTodos(); // Recebe o array retornado da Funçao retornaTodos
        String saida = "Foram Recuperados as seguintes correspondencias :\n";
        for(int i = 0; i < chocolates.size(); ++i){ //Salva todos os itens numa string
            Chocolate choco = (Chocolate) chocolates.get(i);
             saida += choco.toStringALL() + "\n"; 
        }
