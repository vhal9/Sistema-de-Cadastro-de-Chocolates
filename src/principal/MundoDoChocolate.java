...
public class MundoDoChocolate {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Menu menu = new Menu("choco.txt"); // Instancia de um novo menu de controle das funcoes
            ...
            if(escolha == null)
                ...
                switch(escolha.charAt(0)){
                    ...
                    case 'b':{ //Busca de dados
                        ...
                        if(!lista.isEmpty()){ //Se foi encontrado algum valor eles sao listados
                    ...
                    case 'l':{//opcao listar todos
                        menu.ListarTodos(); // chamada do procedimento para listar todos
